...
namespace Accio\PostType\Controllers;
...
class BasePostTypeController extends MainController
{
    ...
    public function deleteField(string $postTypeSlug, string $fieldSlug)
    {
        if (Schema::hasColumn($postTypeSlug, $fieldSlug)) {
            Schema::table(
                $postTypeSlug, function ($table) use ($fieldSlug) {
        ...
        if($postType) {
            ...
            if(User::hasAccess($postType->slug, 'categories', 'hasAll')) {
                $categories = DB::table('categories')
                    ...
                    ->select(
                        'categories.categoryID', 'categories.title', 'categories.slug', 'categories.createdByUserID', 'categories.order', 'categories.featuredImageID',
                ...
                $categories = DB::table('categories')
                    ...
                    ->orderBy('name', 'postTypeID')
                    ->select(
                        'categories.categoryID', 'categories.categoryID', 'categories.slug', 'categories.createdByUserID', 'categories.order', 'categories.featuredImageID',
                        'categories.description', 'categories.created_at', 'categories.updated_at', 'post_type.name'
                    )
                    ->get();
            }
