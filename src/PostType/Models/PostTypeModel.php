...
namespace Accio\PostType\Models;
...
use Accio\PostType\Models\Traits\PostTypeTrait;
...
class PostTypeModel extends Model
{
     ...
     */
    protected $fillable = [
      'createdByUserID', 'name', 'slug', 'isVisible', 'fields', 'hasCategories', 'isCategoryRequired', 'hasTags',
        'isTagRequired'
    ];
