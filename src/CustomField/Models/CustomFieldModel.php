...
namespace Accio\CustomField\Models;

use Accio\Support\BootEventsTrait;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Support\Facades\Event;
use Accio\CustomField\Models\Traits\CustomFieldTrait;
...
class CustomFieldModel extends Model
{
     ...
     * @var array $fillable
     */
    protected $fillable = ['customFieldID', 'customFieldGroupID', 'parentID', 'label','slug', 'placeholder', 'type', 'note',
        'defaultValue', 'optionsValues', 'conditions', 'order', 'isRequired', 'isTranslatable', 'isMultiple', 'isDisabled',
        'isReadOnly', 'isActive', 'wrapperStyle', 'fieldStyle', 'typeAttributes','layout','created_at','updated_at'];
