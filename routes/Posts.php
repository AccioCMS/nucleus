...
Route::group(
    ['as' => 'backend.post.', 'namespace' => '\App\Http\Controllers\Backend', 'prefix' => Config::get('project')['adminPrefix']], function () {
 ...
 */
Route::group(
    ['middleware' => ['auth'], 'as' => 'Backend.Posts.', 'namespace' => \App\Models\Theme::controllersNameSpace()], function () {
